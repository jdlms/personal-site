...
<div class="w-20 h-36 p-5 rounded-lg border border-link flex items-center md:w-72 md:h-28 md:p-4">
	<div class="mr-2 text-highlight md:ml-4">
	...
	<p class="text-xs font-medium ml-4 font-mono text-text-heading">These are blog posts I've collected from rss, or just around the internet, that for one reason I wanted to bookmark and  really resonated with me</p>
</div>
